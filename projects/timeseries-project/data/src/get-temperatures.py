...
<head>
    ...
    <title>get-temperatures.py (editing)</title>
...
data-base-url="/"
data-file-path="advanced-machine-learning/projects/timeseries-project/src/get-temperatures.py"
